...
<div class="headBody" id="headBody">
    ...
    <div class="headCnt clearfix">
        ...
        <ul class="main-nav">
            ...
            <li><h2><a id="bankCard" href="${pageContext.request.contextPath}/bankCard.jsp" class="/webPage/index/insurance.html">认证<i></i></a></h2></li>
        </ul>
        <div class="login-right">
            ...
            <c:choose>
                <c:when test="${empty user}">
                    <div class="no-login">
                        <a href="${pageContext.request.contextPath}/register.jsp" class="btn-reg">注册</a>
...
<div id="ewm" class="ewm_layer" style="display:none;">
    ...
    <div class="ewm_weixin">
        <h3>橘子网服务号</h3>
        <h4>更多服务请关注橘子网服务号</h4>
        <div class="ewm"><img src="images/ewm_fwh.jpg" alt="橘子网服务号"></div>
    </div>
    <div class="ewm_weixin">
        <h3>橘子网订阅号</h3>
        <h4>获取橘子网最新资讯</h4>
        <div class="ewm"><img src="images/ewm_dyh.jpg" alt="橘子网订阅号"></div>
    </div>
</div>
<!-- 二维码弹出层end -->