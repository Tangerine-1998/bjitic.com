...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
   	...
   	<meta name="description" content="橘子金融网是动力教育集团旗下一站式互联网金融平台.接入支付清算协会风险系统，用互联网技术和金融创新使投资与借贷更透明、更高效.优选互联网金融产品随心选。"/>
    <title>橘子金融网官网-专业的互联网金融信息服务平台</title>
    ...
    <div class="registerBody">
		...
		<c:choose>
			<c:when test="${empty user}">
				<div class="register">
					<h3>橘子金融网历史年化收益率</h3>
					<h4><span id="avg">${historyAverageYearRate}</span>%</h4>
					<div class="bn_register"><a href="register.jsp" class="btn-1">注册领666大红包</a></div>
					<div class="login">有账号? <a href="login.jsp">立即登录</a></div>
				</div>
			</c:when>
			<c:otherwise>
				<div class="register welcome">
					<div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来橘子金融网投资！</div>
...
<div id="productArea">
	...
	<div class="index-exper">
		<c:forEach items="${xLoanInfoList}" var="xLoanInfo" varStatus="xLoanInfoStatus">
			 <div class="inner">
	...
	<div class="mainBox pro-body clearfix">
		...
		<c:forEach items="${uLoanInfoList}" var="uLoanInfo" varStatus="uLoanInfoStatus">
